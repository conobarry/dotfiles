...
--   local _textbox = {}
--   setmetatable(_textbox, textbox)

--   _textbox = wibox.widget {
--     widget = textbox
--   }

--   local textbox_attributes = {
--     "markup",
--     "text",
--     "ellipsize",
--     "wrap",
...
--   for _, attr in pairs(textbox_attributes) do
--     if args[attr] then _textbox[attr] = args[attr] end
--   end
--   return _textbox
...
--   {
--     __call = function(_, ...) return textbox:new(...) end
--   }
-- )
